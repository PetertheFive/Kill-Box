...
#define HAL_KEY_SW_6_IENBIT   BV(1) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_6_ICTL     P1IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_6_ICTLBIT  BV(1) /* P0IEN - P1.2 enable/disable bit */
#define HAL_KEY_SW_6_PXIFG    P1IFG /* Interrupt flag at source */

/* Reed Switch GPIO Setting */
/* SW_5 is at P1.1 */
#define HAL_KEY_SW_5_PORT   P1

#define HAL_KEY_SW_5_BIT    BV(1)
...
#define HAL_KEY_SW_5_IENBIT   BV(1) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_5_ICTL     P1IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_5_ICTLBIT  BV(1) /* P2IEN - P1.1 enable/disable bit */
...
//  }
  ...
  if ((!HAL_PUSH_BUTTON2())&&(!UV_Auto_Turn_Off))
  {
    keys |= HAL_KEY_SW_3;
  }  
