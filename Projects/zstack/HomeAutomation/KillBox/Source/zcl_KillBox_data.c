...
const uint8 zclSampleLight_ManufacturerName[] = { 11, 'K','i','l','l',' ','B','o','x','-','A','0',' ',' ',' ',' ',' ' };
const uint8 zclSampleLight_ModelId[] = { 8, 'K','i','l','l',' ','B','o','x',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 zclSampleLight_DateCode[] = { 8, '2','0','2','0','0','7','1','6',' ',' ',' ',' ',' ',' ',' ',' ' };
